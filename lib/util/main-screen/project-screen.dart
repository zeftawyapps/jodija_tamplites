...
Widget  Function   (BuildContext context ,ScreenType screenType ,double width , double hight  ) screenBulder ;
  @override
...
class _ProjectScreenBulderState extends State<ProjectScreenBulder> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: widget.screenBulder(context , ScreenTypeExtension.fromMediaQueryData(MediaQuery.of(context)) , MediaQuery.of(context).size.width , MediaQuery.of(context).size.height)
    );
  }
